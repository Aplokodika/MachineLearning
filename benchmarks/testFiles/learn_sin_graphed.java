...
public class MainFnc {
	...
	public static void main(String[] arg) throws Exception {
		...
		SolutionSpace2DGrey.ChangableWeightParameters temp1 = 
								new SolutionSpace2DGrey.ChangableWeightParameters();
		SolutionSpace2DGrey.ChangableWeightParameters temp2 = 
								new SolutionSpace2DGrey.ChangableWeightParameters();

		SolutionSpace2DGrey.ChangableWeightParametersPair tempPair = 
								new SolutionSpace2DGrey.ChangableWeightParametersPair();
